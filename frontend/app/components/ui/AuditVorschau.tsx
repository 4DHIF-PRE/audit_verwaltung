...
interface Props {
    ...
    return (
        <div className="flex-1 ml-6 bg-gray-200 p-4 rounded-md center" style={{ backgroundColor: "#dcdcdc" }}>
        {selectedAuditDetails ? (
          <div>
            ...
            <p><strong>Thema:</strong> {selectedAuditDetails.au_theme}</p>
            <p><strong>Typ:</strong> {selectedAuditDetails.au_typ}</p>
          </div>
        ) : (
